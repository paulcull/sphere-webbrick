...
export DRIVERNAME="sphere-webbrick" # So I can easily use this script on the next driver!
...
export GOPATH=/Users/paul/Documents/code/go/ # Change this to point to your go project.
#export GOROOT=/Users/paul/Documents/code/go # Change this to point to the location of your go installation
...
function saveOptions {
  echo "Saving options not implemented" 
}
...
#   "test" "Run main.go test for go-webbrick"\
...
if [ $INPUT = "deploy" ] ; then
  ...
  dBuild # Sets environment variables and builds the driver using go build
    ...
    echo "Running go-webbrick test.. "
    go run ../go-webbrick/tests/main.go
